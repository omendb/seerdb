...
fn main() {
    ...
    let negative: Vec<String> = (1000..1000 + size)
    ...
    println!(
        ...
        tp,
        positive.len(),
        (tp as f64 / positive.len() as f64) * 100.0
    );
    println!(
        "  False Negatives: {} / {} ({:.1}%)",
        fn_count,
        positive.len(),
        (fn_count as f64 / positive.len() as f64) * 100.0
    );
    println!();
    ...
    println!(
        ...
        tn,
        negative.len(),
        (tn as f64 / negative.len() as f64) * 100.0
    );
    println!(
        "  False Positives: {} / {} ({:.1}%)",
        fp,
        negative.len(),
        (fp as f64 / negative.len() as f64) * 100.0
    );
    println!();
    ...
    let test_negative: Vec<String> = (2000..2000 + size)
        .map(|i| format!("key_{:04}", i))
        .collect();
    ...
    println!(
        ...
        test_tp,
        test_positive.len(),
        (test_tp as f64 / test_positive.len() as f64) * 100.0
    );
    println!();
    ...
    println!(
        ...
        test_fp,
        test_negative.len(),
        (test_fp as f64 / test_negative.len() as f64) * 100.0
    );
    println!();
