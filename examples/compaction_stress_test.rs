...
fn main() {
    ...
    let monitor_handle = thread::spawn(move || {
        ...
        loop {
            ...
            if start.elapsed().as_secs() > 60 { break; } // Safety timeout
    ...
    println!("Final Stats:");
    println!("  L0 Files: {}", final_stats.sstables_per_level.get(0).unwrap_or(&0));
    println!("  Total SSTables: {}", final_stats.total_sstables);
    println!("  Write Amplification: {:.2}", final_stats.write_amplification);
